...
class WCWalletType(WalletWizardComponent):
    def __init__(self, parent, wizard):
        ...
        wallet_kinds = [
            ...
            ChoiceItem(key='imported', label=_('Import B1T addresses or private keys')),
        ]
...
class WCImport(WalletWizardComponent):
    def __init__(self, parent, wizard):
        WalletWizardComponent.__init__(self, parent, wizard, title=_('Import B1T Addresses or Private Keys'))
        message = _(
            'Enter a list of B1T addresses (this will create a watching-only wallet), or a list of private keys.')
